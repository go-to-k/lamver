...
func (mr *MockLambdaClientMockRecorder) ListFunctions(ctx any) *gomock.Call {
...
func (mr *MockLambdaClientMockRecorder) ListFunctionsWithRegion(ctx, region any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
